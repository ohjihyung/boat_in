...
<div class="content-page">
						...
						<div class="tab-content">
							<div class="tab-pane active" id="showUncomment">
								  <div class="col-12">
								   <div class="card">
								   	<div class="card-body">								   
								   		<div class="table-responsive2" style="font-size: 1.5em">
	...
	<!-- 답변등록 모달 -->
	<div id="full-width-modal" class="modal fade qnaFontSetting" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel" aria-hidden="true"  >
				...
				<div class="modal-body" style="padding-left: 10%;padding-right: 10%;">
					<div class="border border-light pe-2  ps-2  pt-2 mb-4">
						...
						<div class="d-flex align-items-start"><!-- 질문 적어주는 곳 -->
							...
							<div class="w-100">
								<h4 class="" style="font-weight: bold;margin-bottom: 0%" id="qnaWriter"><!--memberId-->
								</h4>
                                            ...
                                            <span class="input-icon">
                                               <textarea class="form-control" rows="6" cols="160" style="width:95%; resize: none;font-size: 1.15em" id="adminWrite" placeholder="답변을 입력하세요"></textarea>
                                                ...
                                                <div class="float-end" style="padding-right: 5%;padding-top: 2.5%">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect waves-light ms-1 btn-lg" onclick="writeQna()">답변 등록</button>
                                                </div>
                                        </form>
								</div>
							</div>
	...
	<!-- 답변수정 모달 -->
	<div id="full-width-modal2" class="modal fade qnaFontSetting" tabindex="-1" role="dialog" aria-labelledby="fullWidthModalLabel2" aria-hidden="true"  >
		<div class="modal-dialog modal-lg modal-dialog-centered">
			<div class="modal-content">
				<div class="modal-header">
					<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
				...
				<div class="modal-body" style="padding-left: 10%;padding-right: 10%;">
					<div class="border border-light pe-2  ps-2  pt-2 mb-4">
						...
						<div class="d-flex align-items-start"><!-- 질문 적어주는 곳 -->
							<img class="me-2" style="width: 35px" alt="Generic placeholder image" src="/resources/profileImg/questionmark.png"> 
							<div class="w-100">
								<h4 class="" style="font-weight: bold;margin-bottom: 0%" id="qnaWriter2"><!--memberId-->
								</h4>
									...
									<form class="comment-area-box mb-3">
                                            <span class="input-icon">
                                               <textarea class="form-control" rows="6" cols="160" style="width:95%; resize: none;font-size: 1.15em" id="adminWrite2" ></textarea>
                                                ...
                                                <div class="float-end" style="padding-right: 5%;padding-top: 2.5%">
                                                    <button type="button" class="btn btn-secondary btn-lg" data-bs-dismiss="modal">닫기</button>
                                                    <button type="button" class="btn btn-primary waves-effect waves-light ms-1 btn-lg" onclick="modifyQna()">답변 수정</button>
                                                </div>
                                        </form>
								</div>
							</div>
...
function tableShow(){
	...
	$('select[name="qna_dataTable_length"]').css("font-size", "20px");
...
function tableShow2(){
	...
	$('select[name="qna_dataTable2_length"]').css("font-size", "20px");
	$('label').css("font-size", "20px");
}
