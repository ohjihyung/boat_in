		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
				<div class="col-xl-10">
					...
					<nav id="navbar-example2" class="navbar navbar-light bg-white ps-1" style="border-radius: 5px">
						<a class="navbar-brand ps-2"  style="font-size:1.4em"><strong>HOME</strong></a>

						<div class="justify-content-center">
							<ul class="nav nav-pills pe-2">
								<li class="nav-item" style="font-size: 1em;">
										<input type="text" id="inputDateInMyHome" style="text-align: center; outline-style: none; width: 50%; margin-left: 10%; border: none;font-weight: bold;font-size: 1.4em" readonly>
								</li>
							</ul>
						</div>
						...
						<div class="card-body">
								...
								<div class="row">
									...
									<h5 class="card-subtitle text-muted mb-2" style="font-size: 1.2em"><strong>제목 클릭 시 답변 등록창 실행</strong></h5>	
												...
												<table class="table table-hover table-centered mb-0" id="QnATableInAdminHome" style="font-size: 1.2em">
														<thead>
															<tr>
...
<!-- 									<label for="#colorPreviewDiv" class="form-label" style="font-size: 1.2em; margin-left: 3%;">배경</label> -->
	...
	<div id="qnaAnswerModal" class="modal fade oneoneFontSetting" tabindex="-1" role="dialog" aria-labelledby="qnaAnswerModal" aria-hidden="true"  >
				...
				<div class="modal-body" style="padding-left: 10%;padding-right: 10%;">
					<div class="border border-light pe-2  ps-2  pt-2 mb-3">
						...
						<div class="d-flex align-items-start"><!-- 질문 적어주는 곳 -->
							...
							<div class="w-100">
								<h4 class="" style="font-weight: bold;margin-bottom: 0%" id="qnaMemberId"><!--memberId-->
								</h4>
                                            ...
                                            <span class="input-icon">
                                               <textarea class="form-control" rows="6" cols="160" style="width:95%; resize: none;font-size: 1.15em" id="adminWrite" placeholder="답변을 입력하세요"></textarea>
                                                ...
                                                <div class="float-end" style="padding-right: 5%;padding-top: 2.5%">
                                                    ...
                                                    <button type="button" class="btn btn-primary waves-effect waves-light ms-1 btn-lg" onclick="registerQna()">답변 등록</button>
                                                </div>
                                        </form>
								</div>
							</div>
