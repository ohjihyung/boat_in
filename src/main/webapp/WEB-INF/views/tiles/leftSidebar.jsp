                        ...
                        <ul id="side-menu">
                            ...
                            <li>
                                <a class="boat-a" href="javascript:0"  data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="true" aria-controls="collapseExample">
									...
									<span class="badge badge rounded-pill bg-danger ms-1 float-end" id="projectLength"></span>
                                </a>
                            </li>
                            <div class="collapse" id="collapseExample">
		                            <div class="h-100" data-simplebar style="max-height: 200px;">
                            ...
                            <li>
                                <a class="boat-a" href="javascript:0" data-bs-toggle="collapse" data-bs-target="#collapseExample2" aria-expanded="true" aria-controls="collapseExample2">
									...
									<i class="mdi mdi-chevron-down accordion-arrow"></i>
									<span class="badge badge rounded-pill bg-danger ms-1 float-end" id="projectLength-finished"></span>
                                </a>
                            </li>
                            ...
                            <li class="collapse1 show" >
	                         ...
	                         <li class="collapse1 show" >
	                            <a class="boat-a" href="/letter/home">
	                              <span  class="badge badge rounded-pill bg-danger float-end chkletterinit"></span>
	                              <i class="fe-mail"></i>
	                              <span>쪽지함</span>                                  
	                            </a>
                             </li>
...
<!--                             <hr style="margin-bottom: 10px"> -->
                            ...
                            <li>
                            	 <a href="javascript:void(0);" onclick="pageTab('/admin/qna')" class="boat-a">
                                    <span  class="badge badge rounded-pill bg-danger float-end"></span>
                                    <i class="fe-edit-1"></i>
                                    <span>1:1 문의</span>                                  
                                  </a>
                            </li>
