...
<!--                     <i class="fe-maximize noti-icon" style="color: white"></i> -->
                    	<span class = " position-relative">
                		 <img alt="" src="/resources/profileImg/fullscreen.png" width="28"  class= " position-relative"> 
                       </span>
                </a>
            </li>
            <!-- 자료실 -->
            <li class="dropdown block auth-topbar">
    		...
    		<!-- 알람 -->
            <li class="dropdown notification-list topbar-dropdown auth-topbar" id="notification1">
                <a class="nav-link dropdown-toggle waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img alt="" src="/assets/images/bell.png" width="30"  class= " position-relative" id="bellShake">
...
<!--                     </span> -->
                ...
                <div class="dropdown-menu dropdown-menu-end profile-dropdown " style="font-size: 1.2em;">
                    <!-- item-->
    
                    <!-- item-->
                    <a href="/mypage/home" class="dropdown-item notify-item" style="font-weight: bold">
                        <i class="fe-user"></i>
                        <span>마이페이지</span>
                    </a>
                    ...
                    <!-- item-->
                    <a href="#" class="dropdown-item notify-item" onclick="logout_H();" style="font-weight: bold">
	   ...
	   //console.log( i, "번째 날짜 ",json[i].alarmDate);	
	    ...
	    if(json[i].alrTNo == "4"){
		    ...
		    if(proType== "WEB"){
				...
				str1 += `<p class="badge badge-soft-warning rounded-pill" style="font-size:0.9em;margin-bottom:1%;"><iconify-icon icon="fluent:brain-circuit-24-regular"></iconify-icon>
					\${proName}</p>`;
			}else if(proType == "SISM"){
				str1 += `<p class="badge badge-soft-success rounded-pill" style="font-size:0.9em;margin-bottom:1%;"><iconify-icon icon="clarity:settings-line"></iconify-icon>
					\${proName}</p>`;
			}else if(proType == "APP"){
				str1 += `<p class="badge badge-soft-info rounded-pill" style="font-size:0.9em;margin-bottom:1%;"><iconify-icon icon="ri:apps-2-line"></iconify-icon>
					\${proName}</p>`;
				...
				str1 += `<p class="badge badge-soft-secondary rounded-pill" style="font-size:0.9em;margin-bottom:1%;"><iconify-icon icon="carbon:db2-database"></iconify-icon>
					\${proName}</p>`;
			}
...
// 해당 유저에게 실시간으로 오는 메세지 전체 처리하는 부분 ojh
 function aMessage(){
	...
	// 알람도착시 딸랑이
	let test = document.querySelector("#bellShake");
	test.classList.toggle("shakeshake");
	setTimeout(function(){
		test.classList.toggle("shakeshake");
	},2000)
...
window.addEventListener("DOMContentLoaded", (event) => {
	...
	if (memberId == "admin") {
		const authTopbars = document.querySelectorAll(".auth-topbar");
		authTopbars.forEach(authTopbar => {
