...
<!DOCTYPE html>
 ...
 <!-- ============================================================== -->
            ...
            <!-- ============================================================== -->
<input id="memberId" hidden="hidden" value= "${memberInfo.memberId }" > 
<input id="memberToken" hidden="hidden" value= "${memberInfo.memberToken }" > 
<script type="text/javascript">
let memberId = $('#memberId').val()
 let ddd = '${memberInfo.memberId}'
let memberToken= $('#memberToken').val()
	console.log('아이디: ', ddd )
