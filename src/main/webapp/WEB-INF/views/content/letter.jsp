		...
		<div class="container-fluid">
			...
			<div class="row justify-content-center">
						...
						<div class="card-body">
							...
							<div class="">
								...
								<div class="mail-list mt-4">
									<a href="javascript: void(0);" onclick="showList()" id="showList" class="showbtn text-primary font-18 fw-bold"> <i class="dripicons-inbox me-2"></i>받은 쪽지함 <span id="letterCheckCnt" class=" chkletterinit badge bg-primary rounded-pill float-end ms-2"></span>
									</a> <a href="javascript: void(0);" onclick="sendInbox()" id="sendInbox" class="showbtn font-18"> <i class="mdi mdi-email-send-outline me-2"></i>보낸 쪽지함
									</a> <a href="javascript: void(0);" onclick="markLetterList()" id="showMark" class="showbtn font-18"> <i class="dripicons-star me-2"></i>중요 보관함
									</a> <a href="javascript: void(0);" onclick="trashBox()" id="trashBox" class="showbtn font-18"> <i class="dripicons-trash me-2"></i>휴지통
									</a>
								</div>
								<script type="text/javascript">
									function showcompose(replymemberId){
										...
										$('.showbtn').attr('class','showbtn font-18')
									...
									function showList() {
										...
										$('#letterDetail').css('display','none')
										$('.showbtn').attr('class','showbtn font-18')
										$('#showList').attr('class','showbtn text-primary font-18 fw-bold')
				...
				<div class=" col-10 card">
									...
									<div class="card-body" style="min-height: 500px;">
										...
										<div class="row">
											...
											<div id="trashbtn" class="text-end">
												<button onclick="deleteLetter()" type="button" class="btn btn-danger waves-effect btn-lg letterFont">
					...
					<!-- container -->
					<!-- 작성하기 -->
					<div id="composeLetter" style="display: none;" class="ps-1 pe-1">
						<div class="row d-flex flex-row ">
							<div class="page-title-box d-flex jutify-content-between">
								<h4 class="page-title pt-1">쪽지 보내기</h4>
<!-- 								<button type="button" onclick="letterSend_K()" class="btn btn-primary waves-effect waves-light letterFont"> -->
...
<!-- 									</select> -->
									...
									<select class="form-control select2-multiple letterFont" data-toggle="select2" data-width="100%" multiple="multiple" data-placeholder="  받는 사람">
										<optgroup label="알 수 있는 회원" id="memberListLetter">
										</optgroup>
									</select>
								</div>
							...
							<!-- 							</div> -->
							<div class="mb-3">
								<input name="letterTitle" id="letterTitle" type="text" class="form-control letterFont" placeholder="제목">
							</div>
							<div class="mb-3">
								<input name="letterFile" id="letterFile" type="file" class="form-control letterFont"  multiple />
							</div>
							...
							<button type="button" onclick="letterSend_K()" class="btn btn-primary waves-effect waves-light letterFont float-end">
									<span>보내기</span> <i class="mdi mdi-send ms-2"></i>
							</button>
							<!-- end row -->
					...
					<!-- detail -->
					<div id="letterDetail" class="" style="display: none;">
						<div class="page-title-box">
							<h4 class="page-title mt-1 ms-2">상세보기</h4>
						</div>
						<div class="card p-2">
							<div>
							...
							<div id="dtailContent" class="m-2 font-18"></div>
							<hr />

							<h4 class="mb-3 fw-bold">첨부파일</h4>
							<div class="row" id="letterDetailFile"></div>
							
						</div>

							<div class="my-auto d-flex justify-content-end text-end ">
								<a href="javascript:void(0);" class="btn btn-primary me-2 d-inline btn-lg letterFont" onclick="replyLetter()"><i class="mdi mdi-reply me-1"></i>답장</a>
								<!-- 답장보내기 스크립트 -->
								<script type="text/javascript">
								...
								<button id="detailTrashBtn" onclick="deleteLetterDetail()" type="button" class="btn btn-danger waves-effect waves-light d-inline btn-lg letterFont">
									<i class="mdi mdi-delete"></i> 삭제
								</button>
							</div>
...
//			 scrollX: true,
	...
	$('select[name="letterList_length"]').css("font-size", "20px");
...
/* 즐겨찾기 보관함  */
 function markLetterList(){
	 $('#letterPerson').text('보낸사람')
		...
		$('#letterMark').text('중요')
		$('.showbtn').attr('class','showbtn font-18')
		$('#showMark').attr('class','showbtn text-primary font-18 fw-bold')
...
function sendInbox(){
	...
	$('.showbtn').attr('class','showbtn font-18')
	$('#sendInbox').attr('class','showbtn text-primary font-18 fw-bold')
	$('#trashbtn').attr('class','d-none text-end')
	$('#composeBtn').attr('class', 'fs-3 btn btn-outline-primary w-100 waves-effect waves-light')
	var table = $('#letterList').DataTable({
		responsive:true,
...
function trashBox(){
	...
	$('#letterMark').text('복원')
	$('.showbtn').attr('class','showbtn font-18')
	$('#trashBox').attr('class','showbtn text-primary font-18 fw-bold')
	$('#trashbtn').attr('class','d-none text-end')
	$('#composeBtn').attr('class', 'fs-3 btn btn-outline-primary w-100 waves-effect waves-light')
	var table = $('#letterList').DataTable({
		responsive:true,
