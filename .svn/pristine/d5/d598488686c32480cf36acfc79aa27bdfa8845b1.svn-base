...
<div class="content-page">
	<div class="content">
		...
		<div class="row mt-3">
			<div class="col-xl-12">
				<div class="card" style="height: 785px" data-simplebar>
					<div class="card-body">
						<div>
							<h1 style="font-weight:bold; text-align:center;">통계</h1>
						</div>

						<ul class="nav nav-tabs nav-bordered nav-justified">
							<li class="nav-item quantityFontSetting"><a href="#quanti-member" id="quantiMember"  onclick="printMemberQuanti()" data-bs-toggle="tab" aria-expanded="true" class="nav-link active"><strong>회원관련 통계</strong></a></li>
							<li class="nav-item quantityFontSetting"><a href="#quanti-project"id="quantiProject" onclick="printProQuanti()" data-bs-toggle="tab" aria-expanded="false" class="nav-link "><strong>프로젝트 이용 관련</strong></a></li>
							<li class="nav-item quantityFontSetting"><a href="#quanti-file"   id="quantiFile"    onclick="printFileQuanti()"data-bs-toggle="tab" aria-expanded="false" class="nav-link"><strong>자료 관련</strong></a></li>
							<li class="nav-item quantityFontSetting"><a href="#quanti-else"   id="quantiElse"    onclick="printElseQuanti()"data-bs-toggle="tab" aria-expanded="false" class="nav-link"><strong>기타통계</strong></a></li>
							<li class="nav-item quantityFontSetting"><a href="#quanti-GA"     id="quantiGA"      data-bs-toggle="tab" aria-expanded="false" class="nav-link"><strong>구글애널리틱스</strong></a></li>
						</ul>
...
<!-- 								</div> -->
							...
							<div class="tab-pane text-center" id="quanti-GA" style="height:100px;margin-top: 200px" >
<!-- 								<a href="https://analytics.google.com/analytics/web/?hl=ko#/p350449611/reports/reportinghub"> 애널리틱스 확인 </a> -->
								<button style="width: 30%" class="btn btn-primary waves-effect waves-light btn-lg mt-2" onclick="window.open('https://analytics.google.com/analytics/web/?hl=ko#/report-home/a250498191w351326102p283802461)');">
								<span style="font-size: 1.5em;font-weight: bold">Google Analytics 확인하기</span>
         ...
         var str = `
        	...
        	<div class="col-md-4">
	            <div class="card text-white  bg-warning text-xs-center">
	                <div class="card-body">
	                    ...
	                    <h3 class=" text-white"> <strong> 총개수 :&nbsp&nbsp  <span class="counter-totalFileCnt"> 404</span> 개 </strong></h3>  
	                    </blockquote>
	                </div>
	            </div>
            </div>
        	<div class="col-md-4">
	            <div class="card text-white bg-warning text-xs-center">
	                <div class="card-body">
	                    <blockquote class="card-bodyquote mb-0">
	                    <h3 class="text-white"> <strong > 총사용량 :&nbsp&nbsp  <span class="counter-totalFileSize"> 670</span> MB </strong></h3>  
	                    </blockquote>
	                </div>
	            </div>
            </div>
