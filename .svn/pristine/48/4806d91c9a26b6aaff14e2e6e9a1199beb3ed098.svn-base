			...
			<div class="row" style="height: 750px;">
				<div class="col-lg-12">
					<div class="card h-100">
						<form action="/devin/update" method="post" id="devinForm">
							<input type="hidden" name="dviNo" value="${devinVO.dviNo }" > 
							<input type="hidden" name="memberId" id="memberId" value="" >
							<div class="card-body">
								<div class="form-group">
									<label for="inputName">제목</label> 
									<input type="text" id="dviTitle" name="dviTitle" value="${devinVO.dviTitle }" class="form-control" placeholder="제목을 입력해주세요"><br>
								</div>
								...
								<div class="form-group">
									...
									<br>
									<div id="contents"></div>
									<input type="hidden" name="dviContent" id="concon" value="${devinVO.dviContent }">
								</div>

								<div class="row">
									<div class="col-12">
										<input type="button" value="목록" id="listBtn" class="btn btn-success waves-effect waves-light"> 
										<input type="submit" value="수정" id="formBtn" class="btn btn-primary waves-effect waves-light">
									</div>
								</div>
							</div>
						</form>
