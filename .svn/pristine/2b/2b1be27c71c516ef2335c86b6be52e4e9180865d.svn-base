							...
							<div class="card-body" style="padding-top:9px;">
								<div class="row mb-2">
									<div class="d-flex align-center justify-content-between">
										<h4 class="header-title fs-2 my-auto" id="teamMembersTitle">
											Team Members 
<!-- 											<i class="mdi mdi-account-multiple ms-1"></i> -->
											<a class="d-none" title="팀원 초대하기" onclick="inviteProMem()" id="inviteDiv" style="cursor:pointer;">
												<img alt="" src="/resources/profileImg/add-user.png" style="width:18%;" id="inviteTeamMember">
											</a>
										</h4>
										<!-- 프로젝트 팀원 초대하기 -->
<!-- 										<div class="d-flex" id="inviteDiv" style="display: flex;"> -->
<!-- 											<div class="ms-1 align-middle"> -->
<!-- 												<h5 class="align-middle" id="inviteText"> -->
<!-- 													<a href="javascript:void(0)" onclick="inviteProMem()" id="invitealink" style="color: black;">팀원 초대하기 -->
<!-- 													</a> -->
<!-- 												</h5> -->
<!-- 											</div> -->
<!-- 										</div> -->
								...
								<div class="row ms-2" id="profileList" style="display: flex;">
...
<!-- <MARQUEE> -->
<div class="row fs-3" style="padding-right: 0px;">

<div class="col-md-6 col-xl-3">

	<div class="col-xl-12">
		<div class="widget-rounded-circle card bg-purple shadow" style="height: 100px">
			<div class="card-body" style="padding-top: 4%">
				<div class="row">
					...
					<div class="col-6">
						<div class="text-end">
							<p class="text-white mb-0 text-truncate" style="font-weight: bold">완료된작업</p>
	...
	<div class="col-xl-12">
		<div class="widget-rounded-circle card bg-info shadow-none" style="height: 100px">
			<div class="card-body" style="padding-top: 4%">
				<div class="row">
					<div class="col-6">
						<div class="avatar-lg rounded-circle bg-soft-light">
					...
					<div class="col-6">
						<div class="text-end">
							<p class="text-white mb-0 text-truncate" style="font-weight: bold">진행중 작업</p>
							<h2 class="text-white mt-2">
...
<!-- 마감일이 지난 작업 -->
	<div class="col-xl-12">
		<div class="widget-rounded-circle card bg-pink shadow-none" style="height: 100px">
			<div class="card-body" style="padding-top: 4%">
				<div class="row">
					<div class="col-6">
						<div class="avatar-lg rounded-circle bg-soft-light">
					...
					<div class="col-6">
						<div class="text-end">
							<p class="text-white mb-0 text-truncate" style="font-weight: bold">마감일이 지난작업</p>
							<h2 class="text-white mt-2">
...
<!-- 마감일이 지난 작업 -->
	...
	<div class="col-xl-12">
		<div class="widget-rounded-circle card bg-success shadow-none" style="height: 100px">
			<div class="card-body" style="padding-top: 4%">
				<div class="row">
					<div class="col-6">
						<div class="avatar-lg rounded-circle bg-soft-light">
					...
					<div class="col-6">
						<div class="text-end">
							<p class="text-white mb-0 text-truncate" style="font-weight: bold">총작업</p>
							<h2 class="text-white mt-2">
...
<div class="col-xl-4">
		<div class="card" >
			<div class="card-body"  style="height: 472px">
				...
				<div id="cardCollpase5" class="collapse p-5 show" dir="ltr">
     ...
     axios
       ...
       .then((res) => {
           ...
           if (proAuth == "1" || proAuth == "2") {
        	   document.querySelector("#inviteDiv").className = "";
        	   document.querySelector("#btnFinishProject").style.display = "block";
           } else {
        	   document.querySelector("#inviteDiv").className = "d-none";
        	   document.querySelector("#teamMembersTitle").style.padding = "12px 0px 10px 0px";
           }
...
// 					console.log("myAuth :: ",myAuth)
				...
				var memberAuthName = '#memberAuthName'+i
				 if(res[i].proAuth == '1'){
					 $(memberAuth).attr('class','mdi mdi-check-decagram text-danger');
					 $(memberAuthName).text('PM')
                  }else if(res[i].proAuth == '2'){
					 $(memberAuth).attr('class','mdi mdi-check-decagram text-primary');
