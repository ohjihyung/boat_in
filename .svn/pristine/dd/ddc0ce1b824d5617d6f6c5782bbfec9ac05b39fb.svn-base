		...
		<div class="row mt-3">
			<div class="col-xl-12">
				<div class="card" style="height: 785px" data-simplebar>
					<div class="card-body">
						<div>
							<h1 style="font-weight:bold; text-align:center;">회원/프로젝트 관리</h1>
						</div>

						<ul class="nav nav-tabs nav-bordered nav-justified memberFontSetting">
							<li class="nav-item"><a href="javascript: gridRender();"
								id="member-management" class="nav-link active"><strong>회원관리</strong></a></li>
							<li class="nav-item"><a
								href="javascript: projectGridRender();" id="project-management"
								class="nav-link"><strong>프로젝트 관리</strong></a></li>
						</ul>
...
function grid_createButtons(table) {
    ...
    let buttonText = ``;
    buttonText += `<button class="gridBtn btn btn-success width-sm waves-effect waves-light" id="print-table" style="font-size:1.15em">프린트 하기</button>`;
    buttonText += `<button class="gridBtn btn btn-success width-sm waves-effect waves-light" id="download-json" style="font-size:1.15em">JSON 다운로드</button>`;
    buttonText += `<button class="gridBtn btn btn-success width-sm waves-effect waves-light" id="download-xlsx"  style="font-size:1.15em">XLSX 다운로드</button>`;
    buttonText += `<button class="gridBtn btn btn-success width-sm waves-effect waves-light" id="download-pdf"  style="font-size:1.15em">PDF 다운로드</button>`;
