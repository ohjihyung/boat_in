...
<!-- Google tag (gtag.js) -->
<!-- <script async src="https://www.googletagmanager.com/gtag/js?id=G-J9LESLYQFV"></script> -->
<script>
//   window.dataLayer = window.dataLayer || [];
//   function gtag(){dataLayer.push(arguments);}
//   gtag('js', new Date());

//   gtag('config', 'G-J9LESLYQFV');
</script>

<!-- Google Analytics -->
<script>
window.ga=window.ga||function(){(ga.q=ga.q||[]).push(arguments)};ga.l=+new Date;
ga('create', 'UA-250498191-1', 'auto');
ga('send', 'pageview');
// ga('create', 'UA-250498191-1', 'auto');

ga(function(tracker) {
  // Logs the tracker created above to the console.
  console.log("ga트래커 ::::: ",tracker);
});
ga('create', 'UA-250498191-1', 'auto', 'tracker1');
// ga('create', 'UA-XXXXX-Z', 'auto', 'tracker2');

ga(function() {
  // Logs an array of all tracker objects.
  console.log("ga all ::  ", ga.getAll());
});
</script>
...
/* 김진호 */
.input-no-K, .input-K, .subwork-class {
  font-size: 1.5em     !important;
}
...
.jino-select, .fc-daygrid-day-number, .fc-col-header-cell-cushion, #what, .dataTables_empty {
  font-size: 15px      !important;
  font-weight: bold    !important;
}
.jino-15, .fc-daygrid-more-link{
  font-size: 15px      !important;
}
