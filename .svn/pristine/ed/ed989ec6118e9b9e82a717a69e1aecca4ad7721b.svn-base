...
<title>BOAT-IN</title>
<!-- Bootstrap Core CSS -->
<link href="${pageContext.request.contextPath }/resources/commons/main/css/bootstrap.min.css" rel="stylesheet">
<!-- Custom CSS -->
<link href="${pageContext.request.contextPath }/resources/commons/main/css/theme.css" rel="stylesheet">
<!-- Custom Fonts -->
<link href="${pageContext.request.contextPath }/resources/commons/main/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
...
<div class="container">
	<div class="navbar-header">
		...
		<a class="navbar-brand page-scroll" href="/boatinmain" >
			 <img src="/assets/images/logo-light.png" alt="" height="28"  id="mainLogo">
          </a>
	</div>
	<!-- Collect the nav links, forms, and other content for toggling -->
	<div class="collapse navbar-collapse navbar-right navbar-main-collapse">
		<ul class="nav navbar-nav" style="font-size: 1.15em;font-family: 'IBM Plex Sans KR', sans-serif!important;">
			<li>
				<a href="#"><i class="fe-heart"></i>&nbsp;고객센터</a>
			</li>
			<li>
				<a href="#"><i class="fe-log-in me-1"></i>&nbsp;로그인</a>
			</li>
			<li>
				<a href="#"><i class="fe-edit me-1"></i>&nbsp;회원가입</a>
			</li>
		</ul>
	</div>
	<!-- /.navbar-collapse -->
...
<div class="container text-center">
	<p class="credits">
		&copy; BOAT-IN PRODUCT BY <a href="">WayVe✌</a>
	</p>
</div>
</footer>
<!-- jQuery -->
<script src="${pageContext.request.contextPath }/resources/commons/main/js/jquery.js"></script>
<!-- Bootstrap Core JavaScript -->
<script src="${pageContext.request.contextPath }/resources/commons/main/js/bootstrap.min.js"></script>
<!-- Plugin JavaScript -->
<script src="${pageContext.request.contextPath }/resources/commons/main/js/jquery.easing.min.js"></script>
<!-- Custom Theme JavaScript -->
<script src="${pageContext.request.contextPath }/resources/commons/main/js/theme.js"></script>
</body>
</html>