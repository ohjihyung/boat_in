 ...
 /**
  ...
  @SuppressWarnings({"unchecked"}) public class CommonDao extends EgovAbstractMapper {
 ...
 /**
  ...
  public <T> T select(String queryId) throws Exception{ return (T)
 ...
 /**
  ...
  public <E> List<E> selectList(String queryId) { return (List<E>)
  sqlSession.selectList(queryId); }
 ...
 /**
  ...
  public <E> List<E> selectList(String queryId, Object parameter) { return
  (List<E>) sqlSession.selectList(queryId, parameter); }
 ...
 /**
  ...
  public int insert(String queryId) { return sqlSession.insert(queryId); }
 ...
 /**
  ...
  public int update(String queryId) { return sqlSession.update(queryId); }
 ...
 /**
  ...
  public int delete(String queryId) { return sqlSession.delete(queryId); }
